<footer class="main-footer">
    <strong>Copyright &copy; 2020-2022 <a href="#">Hardik Devaliya</a>.</strong>
    All rights reserved.
...
<!-- REQUIRED SCRIPTS -->
<!-- jQuery -->
<script src="skin/admin/assets/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap -->
<script src="skin/admin/assets/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- overlayScrollbars -->
...
<script src="skin/admin/assets/plugins/raphael/raphael.min.js"></script>
<script src="skin/admin/assets/plugins/jquery-mapael/jquery.mapael.min.js"></script>
