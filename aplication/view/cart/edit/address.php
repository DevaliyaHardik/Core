                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" name="bilingAddress[lastName]" value="<?php echo $bilingAddress->lastName ?>" class="form-control" id="exampleInputLastName" placeholder="Enter Last Name">
                            </div>
                            <div class="form-group">
                            <label for="exampleInputAddress">Address</label>
                            <input type="text" name="bilingAddress[address]" value="<?php echo $bilingAddress->address ?>" class="form-control" id="exampleInputAddress" placeholder="Enter Address">
                            </div>
                            <div class="form-group">
                            <label for="exampleInputCity">City</label>
                            <input type="text" name="bilingAddress[city]" value="<?php echo $bilingAddress->city ?>" class="form-control" id="exampleInputCity" placeholder="Enter City">
                            </div>
                            <div class="form-group">
                            <label for="exampleInputState">State</label>
                            <input type="text" name="bilingAddress[state]" value="<?php echo $bilingAddress->state ?>" class="form-control" id="exampleInputState" placeholder="Enter State">
                            </div>
                            <div class="form-group">
                            <label for="exampleInputPosatalCode">Postal Code</label>
                            <input type="number" name="bilingAddress[postalCode]" value="<?php echo $bilingAddress->postalCode ?>" class="form-control" id="exampleInputPosatalCode" placeholder="Enter Postal Code">
                            </div>
                            <div class="form-group">
                            <label for="exampleInputCountry">Country</label>
                            <input type="text" name="bilingAddress[country]" value="<?php echo $bilingAddress->country ?>" class="form-control" id="exampleInputCountry" placeholder="Enter Country">
                            </div>
