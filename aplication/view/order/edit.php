    ...
    <tr>
        <td>
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <td>Postal Code</td>
                    <td><?php echo $bilingAddress->postalCode; ?></td>
                </tr>
                <tr>
                    <td>Country</td>
...
<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <td align="right" colspan="9"><?php echo $order->shipingCharge; ?></td>
    </tr>
    <tr>
        <td>Grand Total</td>
        ...
        <div class="row">
            ...
            <div class="card card-primary">
                ...
                <div class="card-footer">
                    <button type="button" id="orderStatusUpdateBtn" class="btn btn-primary" name="submit" value="<?php echo $order->order_id ?>">Update</button>
